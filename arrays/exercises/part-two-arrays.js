...
cargoHold.pop();
console.log(cargoHold[6]); //Leaving this here because unsure if purpose of exercise is to demonstrate "undefined" or not//
console.log("security blanket");
console.log(cargoHold);
//3) Remove the first item from the array with shift. Print the element removed and the updated array.
cargoHold.shift();
console.log("oxygen tanks");
